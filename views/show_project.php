...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<![endif]-->
		        <?php include_once('../views/links2.php');?> <!-- navigation-->
	...
	<div id="fh5co-main">
		<div class="fh5co-tab-wrap">
			<ul class="fh5co-tab-menu">
				<li class="active"><a href="#" data-tab="1"><span class="icon icon-glass"></span><span class="menu-text">Description Projet</span></a></li>
				<li><a href="#" data-tab="2"><span class="icon icon-graduation-cap"></span><span class="menu-text">Candidature</span></a></li>
